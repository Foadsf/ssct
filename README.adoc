...
.Arduino Board
image::ex01_pic01.png[align="center", title-align=center, title="An Ardunio Uno board with Potentiometer connected to port A0. (Image courtesy of arduino.cc)", link=https://www.arduino.cc/en/uploads/Tutorial/if_noLED.png]
...
image::ex01_pic02.gif[align="center", title-align=center, title="Live plotting of a potentiometer from Arduino"]
